...
export default class VisibilityPolygon {
	constructor() {
...
// 使用射线检测的方法判断position是否在polygon内部
VisibilityPolygon.inPolygon = function(position, polygon) {
	// 先扫描一遍，取所有x,y值中的最小值val
	// 以position为射线的起始端，以[val-1, val-1]作为射线的末端
	var val = polygon[0][0];
